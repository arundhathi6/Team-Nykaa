...
export const Payment = ()=>{
    return (
      ...
      <div className="option">
        ...
        <div className="login ps-3 pt-3">
          <p className="mb-0 ms-0">1 - LOGIN</p>
          <p className="mt-0 smallemail ms-0">arvindkumarmahato.dhn@gmail.com</p>
        </div>
        <div className="line"></div>
        <div className="address pt-4 ps-3">
          <p className="ms-0">2 - ADDRESS</p>
        </div>
        <div className="line2"></div>
        <div className="payment pt-4 ps-3">
          <p className="ms-0">3 - PAYMENT</p> 
        </div>
        <div className="line2"></div>
     </div>
     <div className="SUggestion">
      <span className="cir">◉ </span>&nbsp;  Please use a digital payment method & help us ensure contactless delivery for your safety
    </div>
    <div className="contain mt-4 d-flex">
    <div className="paymentmode">
        <h6 className="ms-3 mt-3 mb-0 ">CHOOSE PAYMENT METHOD</h6>
        <ul className="list-group list mt-2">
            <li className="list-group-item" id="cd">Credit/Debit Card</li>
            <li className="list-group-item">UPI</li>
            <li className="list-group-item">GooglePay</li>
            <li className="list-group-item">Net Banking</li>
            <li className="list-group-item">Mobile Wallets</li>
            <li className="list-group-item">Cash on Delivery</li>
            <li className="list-group-item">Mobile Wallets</li>
          </ul>
          
    </div>
    <div className="addresstake bg-body shadow-sm  ">
    <p className="ms-3 mt-3">Credit/Debit Card</p>
        <div className="hor">
      </div>
      <label for="card number" className="ms-3 mt-3">Card Number</label><br></br>
      <input type="text"  id="card number" className="mt-1 ms-3" required autocomplete="off"/>
      <div className="hor mt-1">

        </div>
        <label for="expiry" className="ms-3 mt-3">Expiry</label>
        <input type="text"  id="month" className="mt-2 ms-3" placeholder="MM " required autocomplete="off"/>
        <input type="text"  id="year" className="mt-2 ms-0" placeholder=" / YY" required autocomplete="off"/>
        <input type="text"  id="cvv" className="mt-2 ms-3" placeholder="CVV" required autocomplete="off"/>
        <div class="img-fluid d-inline-block ms-2">
          <img src="https://www.nykaa.com/assets/desktop/images/checkout/bank-card-back-side.png" alt=""/>

        </div>
        <div class="cont d-inline-block ms-2">
          <p class="pt-2 ">Last 3 Digits at the back of the Card</p>
        </div>
        <div class="che ms-3 mt-1">
        
         
      
        
         <button class="Payment" id="final_payment_text"  > Pay Now
        </button>
    ...
    <div class="left bg-body shadow-sm ">
          
          <button class="collapsible shadow-lg mt-2"><span class="number__cart"></span> item in your begs</button>
          <button class="collapsible shadow-lg mt-2"><span class="number__cart"></span> Grand Total</button>
    ...
    <div class="foot_address">
      <div>
        <img src="https://th.bing.com/th/id/OIP.EQr6-76DBAMuLdtRXFlyWQHaHa?w=209&h=209&c=7&r=0&o=5&pid=1.7" alt=""/>
        <div>
          <p class="gui_text">GENUINE PRODUCTS</p>
          <p class="sma_text">Sourced Directly From Brands</p>

        </div>
      </div>

      <div>
        <img src="https://th.bing.com/th/id/OIP.d4sjG9Ay47GGHe2JSL2O-wHaHa?w=196&h=196&c=7&r=0&o=5&pid=1.7" alt=""/>
        <div>
          <p class="gui_text">FREE SHIPPING</p>
          <p class="sma_text">For Orders Above Rs.499</p>
        </div>
      </div>


      <div>
        <img src="https://th.bing.com/th/id/OIP.hhXKJ5JrQdUmw2uKPf05qAAAAA?w=174&h=180&c=7&r=0&o=5&pid=1.7" alt=""/>
        <div>
          <p class="gui_text">SECURE PAYMENTS</p>
          <p class="sma_text">Using 128-bit SSL Encryption</p>
        </div>
      </div>
      </div>
