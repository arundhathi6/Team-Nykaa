...
<div className="nav shadow-sm">
     ...
     <div className="contain mt-4 d-flex">
      ...
      <div className="newadress shadow-sm bg-body newADDRESSES">
        <p className="mt-3">New Address</p>
      </div>

        </div>
        <div className="saved-addresses-cont">
        <p>New Address</p>
        <hr></hr>
        <p className ="addressfillup">Select Country</p>
        <label for="card number" className="">India</label><br></br>
        <div className="hor mt-1"></div>
        <form>
      <input type="text"  id="card number" className="text" required autocomplete="off" placeholder="Name"/>
      <div className="hor mt-1">
      </div>

      <input type="Number"  id="card number" className="text" required autocomplete="off" placeholder="Phone Number"/>
      <div className="hor mt-1">
      </div>


      <input type="Number"  id="card number" className="text" required autocomplete="off" placeholder="Postal code"/>
      <div className="hor mt-1">
      </div>

      <input type="text"  id="card number" className="text" required autocomplete="off" placeholder="Address"/>
      <div className="hor mt-1">
      </div>
      </form>

      <div className="edit-ship-cont">
      <div className="che ms-3 mt-1">
   
      <div className="mt"> <input type="checkbox" /></div>
      <div className="text"  > Save this Address for Future</div>
    

        
        </div>
      <button className="redirect_paybtn">SHIP TO THIS ADDRESS </button>
      </div>
     ...
     <div className="foot_address">
      <div>
        ...
        <div>
          <p className="gui_text">GENUINE PRODUCTS</p>
          <p className="sma_text">Sourced Directly From Brands</p>
      ...
      <div>
        ...
        <div>
          <p className="gui_text">FREE SHIPPING</p>
          <p className="sma_text">For Orders Above Rs.499</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div>
          <p className="gui_text">SECURE PAYMENTS</p>
          <p className="sma_text">Using 128-bit SSL Encryption</p>
        </div>
